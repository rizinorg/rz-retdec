#  This file originated in https://github.com/rizinorg/rz-ghidra project under LGPLv3 license.
#
# - Find Rizin (librz)
#
...
if(WIN32)
	find_path(Rizin_INCLUDE_DIRS
		NAMES rz_core.h rz_bin.h rz_util.h rz_userconf.h
		HINTS
			"${RIZIN_INSTALL_PATH}/include/librz"
	...
	find_path(SDB_INCLUDE_DIR
		...
		HINTS
			"${RIZIN_INSTALL_PATH}/include/librz/sdb"
	...
	foreach(libname ${Rizin_LIBRARY_NAMES})
		find_library(Rizin_LIBRARY_${libname}
				rz_${libname}
				HINTS
				"${RIZIN_INSTALL_PATH}/bin/prefix/rizin/lib"
